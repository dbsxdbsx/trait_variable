//! This file contains a basic test case for the `trait_variable` crate.
//! It demonstrates the usage of trait variables and their associated macros.
...
impl MyTraitForBasic for MyStruct {
    fn change_and_print_a(&mut self, new_num: i32) {
        self.a = new_num;
        println!("a: `{}`", self.a);
    }
